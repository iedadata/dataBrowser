...
$(document).ready(function(){
	...
	//USAP
	var usap_url = "/databrowser/sp/inc/usap_pass_through.php?wkt=POLYGON(("+poly_str+"))";
	//var gcsearchurl = "http://www.geochron.org/polygonsearch?srs=3031&polygon="+poly_str;
	requests.push($.ajax({
	    url: usap_url,
	    success: function(ev) {
	...
	var sesarurl = "/databrowser/sp/inc/sesar_polygon_wrapper.php?polygon={0}&srs=3031&hide_private=1&limit=1&page_no=1".format(poly_str);
